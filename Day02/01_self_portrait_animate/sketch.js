...
function draw() {
  ...
  //eyeball
  fill(0,0,0);
  ellipse(176,198, mouseY/20);
  ellipse(221,198, mouseY/20);
  
  //eye highlight
  fill(255,255,255);
  ellipse(155+mouseX/10,177+mouseY/20, 4,4);
  ellipse(200+mouseX/10,177+mouseY/20, 4,4);
